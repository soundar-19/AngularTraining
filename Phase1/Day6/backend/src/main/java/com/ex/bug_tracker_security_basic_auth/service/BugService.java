...
public class BugService {
    ...
    public List<BugResponseDTO> filterBugs(String status, String assignee, String project){
        ...
        .map(bug -> new BugResponseDTO(bug.getId(), bug.getTitle(), bug.getStatus(), bug.getAssignee(), bug.getProject(), bug.getPriority()))
        .toList();
    }
    ...
    public List<BugResponseDTO> getByStatus(String status) {
        ...
        .map(bug -> new BugResponseDTO(bug.getId(),bug.getTitle(),bug.getStatus(),bug.getAssignee(),bug.getProject(),bug.getPriority())).toList();
    }
    ...
    public Page<BugResponseDTO> getAllBugs(Pageable pageable){
        return bugRepository.findAll(pageable).map(bug -> new BugResponseDTO(bug.getId(), bug.getTitle(), bug.getStatus(), bug.getAssignee(), bug.getProject(), bug.getPriority()));
    }
